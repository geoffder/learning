...
from LP_mlp import forward, derivative_w2, derivative_w1, derivative_b2, derivative_b1
...
def main():
    ...
    for i in range(max_iter):
        for j in range(n_batches):
            ...
            # divide gradient by sqrt of cache (greater learning history -> less new learning)
    ...
    Y, _ = forward(Xtest, W1, b1, W2, b2)
    print('final error rate (RMSprop):', error_rate(Y, np.argmax(Ttest, axis=1)))
