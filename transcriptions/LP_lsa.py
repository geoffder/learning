...
titles = [line.rstrip() for line in open('LP_book_titles.txt')]

# copy tokenizer from sentiment example
stopwords = set(w.rstrip() for w in open('LP_stopwords.txt'))
...
# create a word-to-index map so that we can createour word-frequency vectors
